...
/// <param name="ApplicationMethod">PRESCRIPTION stage: the application method.</param>
/// <param name="SprayVolume">PRESCRIPTION stage: the spray volume.</param>
/// <param name="PreHarvestInterval">PRESCRIPTION stage: the pre-harvest interval.</param>
/// <param name="AgronomistRecommendations">PRESCRIPTION stage: the agronomist recommendations.</param>
/// <param name="RequiredPPE">PRESCRIPTION stage: the required personal protective equipment.</param>
