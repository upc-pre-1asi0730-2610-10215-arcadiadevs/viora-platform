...
namespace ArcadiaDevs.Viora.Platform.Agronomic.Infrastructure.Persistence.Configurations;

/// <summary>
///     Entity type configuration for the Plot aggregate root.
/// </summary>
public class PlotEntityTypeConfiguration : IEntityTypeConfiguration<Plot>
{
    /// <summary>
    ...
    public void Configure(EntityTypeBuilder<Plot> builder)
    {
        ...
        // Ignore audit properties (managed by interceptor)
